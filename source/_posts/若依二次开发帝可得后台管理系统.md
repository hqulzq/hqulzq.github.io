...
<img src="image-20240514214918913.png" alt="image-20240514214918913" style="zoom:72%;" />
...
![image-20240607111610267](image-20240607111610267.png)
...
![image-20240614102316989](image-20240614102316989.png)
...
![image-20231203203535648](image-20231203203535648.png)
...
<img src="image-20231203205500858-171869715719416.png" alt="image-20231203205500858" style="zoom:67%;" />
...
![image-20240620093047213](image-20240620093047213.png)
...
![image-20240620105247310](image-20240620105247310.png)
...
![image-20240630161558158](image-20240630161558158.png) <img src="image-20240710101123724.png" alt="image-20240710101123724" style="zoom: 67%;" />  

我们了解到在新增设备时，添加设备和货道表，还包含点位和设备类型的查询，共涉及到四张表的操作。

这个过程需要我们仔细处理每个字段，确保数据的一致性和完整性

![image-20240710170114925](image-20240710170114925.png)
...
![image-20240710094831550](image-20240710094831550.png)

根据前端提交的点位ID，后端需要查询点位表，来获取点位的详细信息，包括详细地址、商圈类型、区域ID和合作商ID，获取到点位信息后，我们需要更新设备表中的相关冗余字段。

![image-20240710202709375](image-20240710202709375.png)
...
![image-20240711094001513](image-20240711094001513.png)

### 创建二级菜单

![image-20240626173707709](image-20240626173707709.png) ![image-20240626172011769](image-20240626172011769.png)
...
![image-20240630100722719](image-20240630100722719.png)
...
![image-20240630102454674](image-20240630102454674.png)
...
![image-20240630100852212](image-20240630100852212.png)  

#### ②配置代码生成信息

导入策略表

![image-20240630101015020](image-20240630101015020.png)  

配置策略表（参考原型）

![image-20240630101043469](image-20240630101043469.png)  

![image-20240630103023330](image-20240630103023330.png)

![image-20240630101224680](image-20240630101224680.png)

#### ③下载代码并导入项目

选中策略表生成下载

 ![image-20240630102002000](image-20240630102002000.png)

解压`ruoyi.zip`得到前后端代码和动态菜单sql

![image-20240630102039555](image-20240630102039555.png)  

代码导入

 ![image-20240630102317850](image-20240630102317850.png) ![image-20240630102423801](image-20240630102423801.png)
...
![image-20240630102546807](image-20240630102546807.png)
...
![image-20240630103824304](image-20240630103824304.png)
...
![image-20240630104801234](image-20240630104801234.png)
...
![image-20240630110417850](image-20240630110417850.png)

## 生成基础代码

### 需求

使用若依代码生成器，生成商品类型、商品管理前后端基础代码，并导入到项目中： ![image-20240630122651738](image-20240630122651738.png)
...
![image-20240630121056783](image-20240630121056783.png)

#### ②配置代码生成信息

导入二张表

![image-20240630121143428](image-20240630121143428.png)

配置商品类型表（参考原型）

![image-20240630121215844](image-20240630121215844.png)

![image-20240630121329378](image-20240630121329378.png)

![image-20240630121558343](image-20240630121558343.png)

配置商品表（参考原型）

![image-20240630121430008](image-20240630121430008.png)

![image-20240630122047727](image-20240630122047727.png)

![image-20240630122122679](image-20240630122122679.png)

#### ③下载代码并导入项目

选中商品表和商品类型表生成下载

![image-20240630122221412](image-20240630122221412.png)  

解压`ruoyi.zip`得到前后端代码和动态菜单sql

![image-20240630122248478](image-20240630122248478.png)

代码导入

  ![image-20240630122353216](image-20240630122353216.png) ![image-20240630122424605](image-20240630122424605.png) ![image-20240630122616266](image-20240630122616266.png)
...
![image-20240630122749105](image-20240630122749105.png)
...
![image-20240630125831347](image-20240630125831347.png)
...
![image-20240716214223061](image-20240716214223061.png)  ![image-20240716214154124](image-20240716214154124.png)
...
![image-20240630155543194](image-20240630155543194.png)
...
![image-20240630142240399](image-20240630142240399.png)
...
![image-20240719160225644](image-20240719160225644.png)

<img src="image-20240719160337360.png" alt="image-20240719160337360" style="zoom:57%;" />
...
![image-20240719162954927](image-20240719162954927.png)

② 从资料中复制货道的视图组件到views/manage/vm目录下

![image-20240719163117366](image-20240719163117366.png)
...
![image-20240719165325959](image-20240719165325959.png)
...
![image-20240722162323740](image-20240722162323740.png)  
...
![image-20240722154846604](image-20240722154846604.png)
...
![image-20240722155046847](image-20240722155046847.png)   ![image-20240722203758387](image-20240722203758387.png)

#### ②添加数据字典

先创建`工单状态`的字典类型

 ![image-20240722204652594](image-20240722204652594.png)

![image-20240722204737663](image-20240722204737663.png)  

再创建`工单状态`的字典数据

![image-20240722204956956](image-20240722204956956.png)

 ![image-20240722205033489](image-20240722205033489.png)  

先创建`工单创建类型`的字典类型

![image-20240722205105502](image-20240722205105502.png)

![image-20240722205128155](image-20240722205128155.png)

再创建`工单创建类型`的字典数据

![image-20240722160506242](image-20240722160506242.png)

![image-20240722205158812](image-20240722205158812.png)  

#### ③配置代码生成信息

导入四张表

![image-20240722162617583](image-20240722162617583.png)

配置工单表（运维、运营）

![image-20240722161206343](image-20240722161206343.png)  

![image-20240722161237298](image-20240722161237298.png)

![image-20240722205625960](image-20240722205625960.png)

配置工单类型表（工单原型）

![image-20240722161701699](image-20240722161701699.png)  

![image-20240722161727464](image-20240722161727464.png)

![image-20240722161835563](image-20240722161835563.png)

配置工单详情表（工单原型）

![image-20240722161908247](image-20240722161908247.png)  

![image-20240722162850400](image-20240722162850400.png)

![image-20240722162906011](image-20240722162906011.png)  

创建自动补货任务表（工单原型）

![image-20240722163046710](image-20240722163046710.png)

![image-20240722163056885](image-20240722163056885.png)

![image-20240722163112340](image-20240722163112340.png)

#### ④下载代码并导入项目

选中四张表生成下载

![image-20240722163159812](image-20240722163159812.png)  

解压`ruoyi.zip`得到前后端代码和动态菜单sql

> 注意：工单管理只需要后端代码，前端使用资料中的

![image-20240722163438233](image-20240722163438233.png)

代码导入

![image-20240722163548428](image-20240722163548428.png)

#### ⑤配置工单前端代码

1）从资料中复制工单api请求js文件到api/manage目录下

 ![image-20240722164320618](image-20240722164320618.png)

4）从资料中复制货道的视图组件到views/manage目录下

![image-20240722164423267](image-20240722164423267.png)  

3）创建运营工单二级菜单

![image-20240722210725885](image-20240722210725885.png)  

4）创建运维工单二级菜单

![image-20240722210902394](image-20240722210902394.png)  
...
<img src="image-20240722170521551.png" alt="image-20240722170521551" style="zoom:79%;" />

<img src="image-20240722170554207.png" alt="image-20240722170554207" style="zoom:80%;" />
...
![image-20240722172059458](image-20240722172059458.png)  
...
![image-20240722172113957](image-20240722172113957.png)
...
![image-20240722172059458](image-20240722172059458.png)  ![image-20240722172113957](image-20240722172113957.png)

### 思路

新增工单时序图

![1681295827753](1681295827753.png)

  新增工单业务流程图

![image-20240726100352426](image-20240726100352426.png)
...
![image-20240722200308660](image-20240722200308660.png)
...
![image-20240727142355125](image-20240727142355125.png) ![image-20240722202046114](image-20240722202046114.png)
...
![image-20240729151833677](image-20240729151833677.png)
...
![image-20240729161029907](image-20240729161029907.png)

7、设置文档信息

![image-20240730105638809](image-20240730105638809.png)
...
![image-20240729103454163](image-20240729103454163.png)

资料中提供了运营管理App端安装包

![image-20240729104324699](image-20240729104324699.png)

需要让模拟器中的App能够连接我们自己本地代码，需要修改下URL地址:

![image-20230524223644828](image-20230524223644828.png)

## Java后端

本项目运营管理App的java后端已开发完成，在资料中已提供源码，导入idea中即可

![image-20240729110127325](image-20240729110127325.png)

本项目连接的也是dkd数据库，如果密码不是root可以进行修改

![image-20240729110248889](image-20240729110248889.png)
...
![image-20240729112910697](image-20240729112910697.png)

![image-20240729111817519](image-20240729111817519.png)

帝可得管理端，创建投放工单

![image-20240729112854709](image-20240729112854709.png)

![image-20240729111836202](image-20240729111836202.png)

运营管理App端登录负责此工单员工，即可查看待办工单，可以选择拒绝、接受

![image-20240729112052191](image-20240729112052191.png) ![image-20240729112117934](image-20240729112117934.png)

如果点击接受，帝可得管理端工单状态改为进行

![image-20240729112211068](image-20240729112211068.png)

在进行工单界面，可以点击查看详情，选择取消、完成

![image-20240729112418567](image-20240729112418567.png) ![image-20240729112340223](image-20240729112340223.png)

如果点击完成工单，帝可得管理端工单状态改为完成

![image-20240729112501205](image-20240729112501205.png)

帝可得管理端设备状态改为运营，表示设备投放成功

![image-20240729112529929](image-20240729112529929.png)

### 补货工单

帝可得管理端，货道关联商品（大家练习时，可以全部关联）

![image-20240729112634816](image-20240729112634816.png)

帝可得管理端，创建补货工单

![image-20240729112954052](image-20240729112954052.png)

![image-20240729113007035](image-20240729113007035.png)

运营管理App端登录负责此工单员工，即可查看待办工单，可以选择拒绝、接受

![image-20240729113050603](image-20240729113050603.png) ![image-20240729113059353](image-20240729113059353.png)

如果点击接受，帝可得管理端工单状态改为进行

![image-20240729113149947](image-20240729113149947.png)

在进行工单界面，可以点击查看详情，选择取消、完成

![image-20240729113246006](image-20240729113246006.png) ![image-20240729113259266](image-20240729113259266.png)

如果点击完成工单，帝可得管理端工单状态改为完成

![image-20240729113804130](image-20240729113804130.png)

数据库货道表的库存已同步更新

![image-20240729113930117](image-20240729113930117.png)

## 源码介绍

运营管理App的java后端技术栈：SpringBoot+MybatisPlus+阿里云短信

![image-20240729114254099](image-20240729114254099.png)

# 设备屏幕端

商品列表--选择支付方式--显示支付二维码--用户扫码完成支付

![image-20240729143120206](image-20240729143120206.png)

## 设备屏幕

本项目的设备屏幕客户端部分已经由前端团队进行开发完成，在资料中已提供源码，双击打开`index.html`即可

![image-20240729141233202](image-20240729141233202.png)

## Java后端

本项目设备屏幕端的java后端已开发完成，在资料中已提供源码，导入idea中即可

![image-20240729141617690](image-20240729141617690.png)

## 功能测试

在设备屏幕端加上`innerCode=设备编号`，即可显示当前设备货道信息

![image-20240729142202566](image-20240729142202566.png)

帝可得管理端，设备策略分配，设置折扣信息

![image-20240729142628648](image-20240729142628648.png)

再次访问设备屏幕端，价格就是折扣的了

![image-20240729142715034](image-20240729142715034.png)
...
![image-20240729143443094](image-20240729143443094.png)

用户看到二维码后，拿出手机扫码支付，此时第三方支付平台确认用户支付成功后会回调订单服务。订单服务收到回调信息后修改订单状态，并通知设备发货。

![image-20240729143602326](image-20240729143602326.png)

## 源码介绍

设备屏幕端的java后端技术栈：SpringBoot+MybatisPlus

![image-20240729143843296](image-20240729143843296.png)
...
![image-20240729174725280](image-20240729174725280.png)

对于订单数据模型，下面是示意图：

![image-20240729143804299](image-20240729143804299.png)
